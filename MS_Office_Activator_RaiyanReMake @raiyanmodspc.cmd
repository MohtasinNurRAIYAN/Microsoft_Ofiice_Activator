...
echo           Made by massgravel and ReMake by Raiyan [@raiyanmodspc]
echo              Included Windows and MS Office Telemetry Removing           
echo:
...
echo         ____________________________________________________________
echo: 
call :dk_color2 %_White% "                      " %_Green% "Choose a menu option [1,2]"
choice /C:1230 /N
set _el=!errorlevel!
if !_el!==4  exit /b
...
title  Ohook Activation by Raiyan %masver%
...
call :dk_color %Green% "Office is permanently activated. #Free_Palestine"
echo:
echo Restart Once for applying all the settings Properly
...
echo:
echo Made by massgravel and ReMade by Raiyan [@raiyanmodspc]
)
...
call :dk_color %Green% "Successfully uninstalled Ohook activation ReMade by Raiyan"
)
)
echo __________________________________________________________________________________________
